use crate::{errors::Error, models::ErrorInfo};
...
const END_POINT: &str = dotenv!("END_POINT");
const TOKEN_KEY: &str = "mimosa.token";
...
pub fn set_token(token: Option<String>) {
    let mut storage = StorageService::new(Area::Local).expect("storage was diabled by the user");
